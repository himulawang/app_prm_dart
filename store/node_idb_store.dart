...
class NodeIndexedDBStore extends IIndexedDBStore {
  static const Map store = const {"type":"indexedDB","master":"prm","objectStore":"Node"};

  static Future add(Node model) {
    if (model is! Node) throw new IStoreException(22004);
  ...
  static Future set(Node model) {
    if (model is! Node) throw new IStoreException(22008);
  ...
  static Future del(Node model) {
    if (model is! Node) throw new IStoreException(22010);
